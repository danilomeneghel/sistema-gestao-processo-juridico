...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" name="reu_principal" id="reu_principal" class="form-control" value="{{$model['reu_principal'] or ''}}" readonly="readonly">
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="col-sm-offset-3 col-sm-6">
                <a class="btn btn-default" href="{{ url('/processos') }}"><i class="glyphicon glyphicon-chevron-left"></i> Back</a>
            </div>
        </div>
