...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" name="id_tipo_pedido" id="id_tipo_pedido" class="form-control" value="<?php echo e(isset($model['id_tipo_pedido']) ? $model['id_tipo_pedido'] : ''); ?>" readonly="readonly">
            </div>
        </div>
